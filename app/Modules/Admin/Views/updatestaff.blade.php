	                        ...
	                        <div class="panel panel-primary">
	                            ...
	                            <div class="panel-body">
	                                ...
	                                <div class="form-group">
	                                    ...
	                                    <div class="col-sm-7">
	                                        <input class="form-control" name="first_name" id="first_name" maxlength="100" placeholder="First name" type="text" value="{{ ($staffdetails->name != '') ? $staffdetails->name : old('name') }}">
	                                    </div>
	                                </div>
	                                ...
	                                <div class="form-group">
	                                    ...
	                                    <div class="col-sm-7">
	                                        <input class="form-control" value="{{ ($staffdetails->last_name != '') ? $staffdetails->last_name : old('last_name') }}" name="last_name" id="last_name" maxlength="100" placeholder="First name" type="text">
	                                    </div>
	                                </div>
	                                ...
	                                <div class="form-group">
	                                    ...
	                                    <div class="col-sm-7">
	                                        <input class="form-control" value="{{ ($staffdetails->email != '') ? $staffdetails->email : old('email') }}" name="staff_email" id="staff_email" maxlength="100" placeholder="your_email@email.com" type="email">
	                                    </div>
	                                </div>
