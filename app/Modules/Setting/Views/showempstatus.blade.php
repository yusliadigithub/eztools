...
@section('content')
	...
	<div class="box">
		...
		{!! Form::open(['action'=>['\App\Modules\Setting\Controllers\SettingControllerEmpStatus@update',$setting->employ_status_id], 'method'=>'put', 'class'=>'form-horizontal form-label-left','id'=>'form1', 'files'=>true]) !!}
