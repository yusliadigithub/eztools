		...
		<div class="modal-body">
			<div class="table-responsive">
				<table class="table table-striped jambo_table bulk_action table-bordered">
					...
					<tbody>
						@foreach ($settingrequest as $staff)
						<tr>
							<td align="center">{{ $staff->name }}</td>
							<td align="center">{{ $staff->value }}</td>
							<td align="center">
								<a href="{{ URL::to('setting/showrequest', $staff->request_id) }}"><i class="fa fa-edit"></i></a>
								&nbsp;&nbsp;&nbsp;
								<a class="deletedata" value="{{ route('settingrequest.delete', $staff->request_id) }}" class="btn btn-sm btn-primar" align="center"><i class="fa fa-trash "></i></a>
							</td>
						</tr>
						@endforeach
					</tbody>
			...
			<!--<button type="button" class="btn btn-sm btn-primary"" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus-circle"> Add Star</i></button>-->
		</div>	</div>
...
<link rel="stylesheet" href="{{-- asset('assets/js/zurb-responsive-tables/responsive-tables.css') --}}">
  ...
  <div class="modal fade" id="myModal" role="dialog">
	...
	{!! Form::open(['action'=>'\App\Modules\Setting\Controllers\SettingControllerRequest@store', 'method'=>'post', 'class'=>'form-horizontal form-label-left','id'=>'form1', 'files'=>true]) !!}
