...
@section('content')
	...
	<div class="box">
		...
		{!! Form::open(['action'=>['\App\Modules\Setting\Controllers\SettingControllerRequest@update',$setting->request_id], 'method'=>'put', 'class'=>'form-horizontal form-label-left','id'=>'form1', 'files'=>true]) !!}
