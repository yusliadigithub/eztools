		...
		<div class="modal-body">
			<div class="table-responsive">
				<table class="table table-striped jambo_table bulk_action table-bordered">
					...
					<tbody>
						@foreach ($settingemploy as $staff)
						<tr>
							<td align="center">{{ $staff->name }}</td>
							<td align="center">{{ $staff->value }}</td>
							<td align="center">
								<a href="{{ URL::to('setting/showempstatus', $staff->employ_status_id) }}"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;&nbsp;
								<a class="deletedata" value="{{ route('settingempstatus.delete', $staff->employ_status_id) }}" class="btn btn-sm btn-primar" align="center"><i class="fa fa-trash "></i></a>
							</td>
						</tr>
						@endforeach
					</tbody>
...
<link rel="stylesheet" href="{{-- asset('assets/js/zurb-responsive-tables/responsive-tables.css') --}}">
  ...
  <div class="modal fade" id="myModal" role="dialog">
	...
	{!! Form::open(['action'=>'\App\Modules\Setting\Controllers\SettingControllerEmpStatus@store', 'method'=>'post', 'class'=>'form-horizontal form-label-left','id'=>'form1', 'files'=>true]) !!}
