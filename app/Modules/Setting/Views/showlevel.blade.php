...
@section('content')
	...
	<div class="box">
		...
		{!! Form::open(['action'=>['\App\Modules\Setting\Controllers\SettingControllerLevel@update',$setting->level_id], 'method'=>'put', 'class'=>'form-horizontal form-label-left','id'=>'form1', 'files'=>true]) !!}
