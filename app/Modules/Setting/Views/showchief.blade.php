...
@section('content')
	...
	<div class="box">
		...
		{!! Form::open(['action'=>['\App\Modules\Setting\Controllers\SettingControllerChief@update',$setting->chief_id], 'method'=>'put', 'class'=>'form-horizontal form-label-left','id'=>'form1', 'files'=>true]) !!}
		...
		<div class="modal-body">
			...
			<div class="form-group">
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
					<input class="form-control modaldata" value="{{ ($setting->depart != '') ? $setting->depart : old('depart') }}" type="text" name="depart" id="depart" placeholder="To" />
				</div>				
			</div>
			<div class="form-group">
