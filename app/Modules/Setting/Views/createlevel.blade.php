				...
				<table class="table table-striped jambo_table bulk_action table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td align="center">
								<a href="{{ URL::to('setting/showlevel', $staff->level_id) }}"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;&nbsp;
								<a class="deletedata" value="{{ route('settinglevel.delete', $staff->level_id) }}" class="btn btn-sm btn-primar" align="center"><i class="fa fa-trash "></i></a>
							</td>
						</tr>
						@endforeach
					</tbody>
...
<link rel="stylesheet" href="{{-- asset('assets/js/zurb-responsive-tables/responsive-tables.css') --}}">
  ...
  <div class="modal fade" id="myModal" role="dialog">
	...
	{!! Form::open(['action'=>'\App\Modules\Setting\Controllers\SettingControllerLevel@store', 'method'=>'post', 'class'=>'form-horizontal form-label-left','id'=>'form1', 'files'=>true]) !!}
		...
		<div class="modal-body">
			<div class="form-group">
				...
				<div class="col-md-8 col-sm-9 col-xs-12">
					<input class="form-control modaldata" type="text" name="name" id="name" placeholder="Name" />
				</div>					
			</div>
			<div class="form-group">
				<label class="control-label col-md-2 col-sm-2 col-xs-12">Status</label>
				<div class="col-md-8 col-sm-9 col-xs-12">
					<input class="form-control modaldata" type="text" name="type" id="type" placeholder="Type" />
				</div>					
			</div>
			<div class="form-group">
				<label class="control-label col-md-2 col-sm-2 col-xs-12">Value</label>
				<div class="col-md-8 col-sm-9 col-xs-12">
					<input class="form-control modaldata" type="text" name="value" id="value" placeholder="Value" />
				</div>					
			</div>
		</div>
