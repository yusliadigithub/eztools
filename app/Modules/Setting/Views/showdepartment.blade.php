...
@section('content')
	...
	<div class="box">
		...
		{!! Form::open(['action'=>['\App\Modules\Setting\Controllers\SettingControllerDepartment@update',$setting->department_id], 'method'=>'put', 'class'=>'form-horizontal form-label-left','id'=>'form1', 'files'=>true]) !!}
		...
		<div class="modal-body">
			...
			<div class="form-group">
				...
				<div class="col-md-8 col-sm-8 col-xs-12">
					<input class="form-control modaldata" value="{{ ($setting->type != '') ? $setting->type : old('type') }}" type="text" name="type" id="type" placeholder="Type" />
				</div>					
			</div>
			<div class="form-group">
